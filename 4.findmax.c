...
/* EXCERCISE 4
 Write a parallel program for find the max into an array. (look, the overhead is higher with more processors, you need a big matrix for obtain a good trade of between overhead and speed (SPEED UP)).
